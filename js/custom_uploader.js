jQuery(document).ready(function() {
 ...
 jQuery('#upload_images').on('click', '.remove_image', function() {
	...
	if(document.getElementById('upload_image')){
		var arr = jQuery('#upload_image').val().split(',');
		arr_url = jQuery('#upload_image_url').val().split(',');
		console.log(arr_url);
